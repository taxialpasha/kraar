// Ensure firebaseConfig is not redeclared
    ...
    if ('serviceWorker' in navigator) {
        navigator.serviceWorker.register('/firebase-messaging-sw.js')
            .then(function(registration) {
                ...
                return window.firebaseServices.messaging.useServiceWorker(registration);
            })
            .then(() => {
                // Initialize IndexedDB after service worker registration
                return window.firebaseServices.initIndexedDB();
            })
            .then(() => {
